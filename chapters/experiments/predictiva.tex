...
El caso house-0 (0 actores) constituye una excepción dentro de este patrón y requiere una explicación diferente. Con entropía de $1{,}0 \times 10^{-5}$ —el valor más bajo registrado por cualquier estrategia en toda la validación, incluyendo configuraciones con alta densidad de actores— la estrategia Predictiva muestra un comportamiento atípico a pesar de procesar 620 frames, el mayor throughput en esa configuración. En ausencia de actores, el módulo de predicción de trayectorias no tiene personas que modelar y el costo dinámico $D_{\text{Pred}}(v)$ es cero para todas las fronteras candidatas. La utilidad se reduce, por tanto, a la ganancia de información estática menos el costo de trayecto: $U(v) = I(v) - \mu \cdot \ell(v)$. Con este balance, la estrategia tiende a seleccionar repetidamente las fronteras de mayor ganancia de información local —que suelen concentrarse en zonas cercanas ya parcialmente exploradas— sin dispersarse hacia regiones distantes del mapa. El resultado es un alto número de frames procesados desde un área acotada, pero una distribución de celdas conocidas poco diversa que se traduce en entropía baja. En contraste, Greedy navega siempre a la frontera más cercana por distancia euclidiana, lo que produce un patrón de exploración más uniforme en entornos sin personas. Este hallazgo indica que, cuando la densidad de actores es nula, la función de utilidad de la estrategia Predictiva no genera suficiente incentivo para dispersarse geográficamente, lo que limita su capacidad de exploración en ese escenario específico.
